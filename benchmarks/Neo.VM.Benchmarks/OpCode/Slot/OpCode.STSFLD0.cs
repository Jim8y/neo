...
//
// OpCode.STSFLD0.cs file belongs to the neo project and is free
...
{
    public class OpCode_STSFLD0 : OpCodeBase
    {
        protected override VM.OpCode Opcode => VM.OpCode.STSFLD0;
        ...
        protected override byte[] CreateOneOpCodeScript()
        {
            ...
            b.AddInstruction(Opcode); // STSFLD0
