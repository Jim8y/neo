...
//
// OpCode.STSFLD1.cs file belongs to the neo project and is free
...
{
    public class OpCode_STSFLD1 : OpCodeBase
    {
        protected override VM.OpCode Opcode => VM.OpCode.STSFLD1;
