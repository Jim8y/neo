...
//
// OpCode.STSFLD5.cs file belongs to the neo project and is free
...
{
    public class OpCode_STSFLD5 : OpCodeBase
    {
        protected override VM.OpCode Opcode => VM.OpCode.STSFLD5;
